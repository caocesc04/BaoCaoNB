...
<head>
    ...
    <title>Danh Mục Nhóm Thuộc Tính</title>
...
<body  >
   ...
   <div id="wrapper">
        @include('layouts.DM_Nhom_Thuoc_Tinh.admin_siderbar')

        <div id="page-wrapper" class="gray-bg">
            @include('layouts.DM_Nhom_Thuoc_Tinh.admin_header')
            @yield('content')
            @include('layouts.DM_Nhom_Thuoc_Tinh.admin_footer')
        </div> 
    </div>
